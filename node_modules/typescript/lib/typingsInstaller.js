...
(function (ts) {
    ...
    ts.version = ts.versionMajorMinor + ".0-dev.20171029";
})(ts || (ts = {}));
(function (ts) {
...
(function (ts) {
    ...
    ts.Diagnostics = {
        ...
        Subsequent_variable_declarations_must_have_the_same_type_Variable_0_has_type_1_at_2_but_here_has_type_3: diag(2403, ts.DiagnosticCategory.Error, "Subsequent_variable_declarations_must_have_the_same_type_Variable_0_has_type_1_at_2_but_here_has_typ_2403", "Subsequent variable declarations must have the same type.  Variable '{0}' has type '{1}' at {2}, but here has type '{3}'."),
...
(function (ts) {
    ...
    (function (Parser) {
        ...
        function currentNode(parsingContext) {
            ...
            var nodeContextFlags = node.flags & 2193408;
        ...
        function parseWithStatement() {
            ...
            node.expression = allowInAnd(parseExpression);
            parseExpected(20);
            node.statement = doInsideOfContext(2097152, parseStatement);
            return finishNode(node);
        }
